...
const getRemoteThemeConfig = (req, res) => {
  ...
  res.json({
    ...
    cafeTagline: settings.cafeTagline || 'Your neighbourhood café',
...
const updateRemoteThemeConfig = (req, res) => {
  try {
    ...
    const updated = {
      ...
      ...(req.body.festivalDiscountType !== undefined && { festivalDiscountType: req.body.festivalDiscountType }),
      ...(req.body.festivalDiscountValue !== undefined && { festivalDiscountValue: Number(req.body.festivalDiscountValue) }),
      ...(req.body.festivalDiscountPercent !== undefined && { festivalDiscountPercent: Number(req.body.festivalDiscountPercent) }),
      ...(req.body.excludedFestivalItemIds !== undefined && { excludedFestivalItemIds: req.body.excludedFestivalItemIds }),
      ...(req.body.customFestivalPrices !== undefined && { customFestivalPrices: req.body.customFestivalPrices }),
