...
const getRemoteThemeConfig = (req, res) => {
  ...
  res.json({
    ...
    allowedThemes: ['warm-cafe', 'midnight', 'clean-pro', 'forest', 'sweet-pink', 'shopify-crave', 'neo-brutalism', 'fast-food'],
...
const updateRemoteThemeConfig = (req, res) => {
  try {
    ...
    const allowedThemes = ['warm-cafe', 'midnight', 'clean-pro', 'forest', 'sweet-pink', 'shopify-crave', 'neo-brutalism', 'fast-food'];
